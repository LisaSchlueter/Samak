function [ListGoodPixels] = ana_tbdallpixels(varargin)
%
...
p.addParameter('file','bc_fitallpixels_run110_G_fix12.mat',@(x)ismember(x,{'tbd_allpixels_v1.mat','bc_fitallpixels_run0'}));
p.parse(varargin{:});
