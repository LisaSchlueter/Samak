function myobj = init_bootcampR3541035422(varargin)
%
...
p.addParameter('TimeSec',54738,@(x)isfloat(x) && x>0);
p.addParameter('TD','BootCampSanshiro',@(x)ismember(x,{'DR20','DR30','DR40','DR50','Kle15','Kle15Ext','Kle15Dyn',...
