function myobj = init_bootcampR1(varargin)
%
...
p.addParameter('KTFFlag','SSCW_DCperqU',@(x)ismember(x,{'OFF','SSC','MACE','MACE+WGTSIS','TL','SG','Kle','MACE+RIPPLE','SSC_BC','SSCW_DCperqU'}));
