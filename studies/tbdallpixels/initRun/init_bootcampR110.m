function myobj = init_bootcampR10(varargin)
%
...
p.addParameter('TimeSec',94659840,@(x)isfloat(x) && x>0);
...
p.addParameter('KTFFlag','SSC_BC',@(x)ismember(x,{'OFF','SSC','MACE','MACE+WGTSIS','TL','SG','Kle','MACE+RIPPLE','SSC_BC'}));
...
opt_mace = {...
    'MACE_Bmax_T',6,...
    'MACE_Ba_T',5.830509864864865e-04,...
    'MACE_R_eV',0.93};
