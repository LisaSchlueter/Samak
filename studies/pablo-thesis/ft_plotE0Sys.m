...
% PLOT 1
subplot(3,1,1)
E0All_s = SPAll.TableShortSys(:,2) + E0_i - E_sys_SPAll_s;
E0All_s_e = SPAll.TableShortSys(:,6);
hold on
...
title(['<E_0> = ',num2str(round(E_sys_SPAll_s,rr))])
PrettyFigureFormat;

% PLOT 2
subplot(3,1,2)

E0All_m = SPAll.TableMedSys(:,2) + E0_i - E_sys_SPAll_m;
E0All_m_e = SPAll.TableMedSys(:,6);
hold on
...
title(['<E_0> = ',num2str(round(E_sys_SPAll_m,rr))])
PrettyFigureFormat;


% PLOT 3
subplot(3,1,3)
E0All_l = SPAll.TableLongSys(:,2) + E0_i - E_sys_SPAll_l;
E0All_l_e = SPAll.TableLongSys(:,6);
hold on
...
title(['<E_0> = ',num2str(round(E_sys_SPAll_l,rr))])
...
PrettyFigureFormat;
export_fig('plots/E0SysAllRuns.pdf','-pdf');
