...
for uncertainty = 1:1
    ...
    for range = 1:Nranges
        ...
        % Call Analysis class
        MRA = MultiRunAnalysis('AnaFlag','StackPixel','PixList',PixelList,...
        ...
        GeneralTable = [MRA.FitResult.par,MRA.FitResult.err,...
            MRA.FitResult.chi2min,MRA.FitResult.dof];
