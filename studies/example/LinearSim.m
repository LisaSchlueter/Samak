...
%
% Note: For mimimizations based on using '../tools/fitter/fminuit.m and '../tools/fitter/minimize.m' 
%       the simulation model must provide a method (here: 'y=compute(obj,varargin)') that accepts 
%       parameters in pairs of ''name',value' and returns an array which reflects the simulated 
%       theory.
%
