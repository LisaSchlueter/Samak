function myobj = ref_VFT2updown(varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% CONFIGURATION FILE
...
p.addParameter('TimeSec',3720,@(x)isfloat(x) && x>0);
p.addParameter('WGTS_CD_MolPerCm2',5e17*0.8);
...
opt_fpd = {...
    'FPD_Segmentation','OFF','FPD_Pixel',1};
