function myobj = ref_run40257(varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% CONFIGURATION FILE
...
p.addParameter('WGTS_MolFrac_DT',0.009);
...
p.addParameter('BKG_RateAllFPDSec',0.35,@(x)isfloat(x) && x>=0);
...
opt_fpd = {...
    'FPD_Segmentation','OFF','FPD_Pixel',1,'FPD_MeanEff',0.9};
