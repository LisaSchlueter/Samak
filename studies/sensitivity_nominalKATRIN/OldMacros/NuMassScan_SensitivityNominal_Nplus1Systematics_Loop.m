function [mNu_Fit, parScan, errScan, chi2minScan, dof ,mNu90,mNumin] = NuMassScan_SensitivityNominal_Nplus1Systematics_Loop(varargin)
p = inputParser;
p.addParameter('SysBudget','04',@(x)ischar(x));
...
save_name = sprintf('./results/%s_%0.0fd_SensitivityNominal_ResultsNuMassScan_MTD-%s_Ba%.0fG_Bs%.2fT_SystematicsNplus1.mat',SysBudget,round(TimeSec/(86400)),TDlabel,MACE_Ba_T*1e4,WGTS_B_T);
