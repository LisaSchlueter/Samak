...
% minimization problems for analyzing the tritium beta decay model. Namely, the simulation class 
% 'exLinearSim.m'l is situated in '../simulation' and includes a method 'compute(vargargin)' which 
% returns an array of values and accepts two parameters in the form of ''name',value' pairs:
% 'slope' and 'offset'. 
% The minimization function comparing the theory and data is defined in 'minimize.m'. This function
% is minimized using the minimization program MINUIT ('fminuit.m').
%
