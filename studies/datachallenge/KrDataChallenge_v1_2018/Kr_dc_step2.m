...
classdef Kr_dc_step2 < handle & FPD & WGTSMACE
    ...
    properties (Access=public, Hidden = true)
        ...
        % L3_32 - single pixel  %Krypton Data Challenge 18: Benchmark
        L3_32_E_i     = 30472.2; L3_32_E;     % Mean Energy, eV
        L3_32_W_i     = 1.28;    L3_32_W;     % Width, eV
        L3_32_Phi0_i  = 66.3;     L3_32_Phi0;  % Intensity
    ...
    methods
        function obj = Kr_dc_step2(varargin)
            ...
            % qU / Te match
%            obj.qUTeMatch = obj.FindqUTeMatch(1.05e-2);
            obj.qUTeMatch = obj.FindqUTeMatch(2.5e-2);
...
%                     end
                case {'KrL3_32','KrL3_32_HS','MoSFitterJuly2017','DummyKrdc1'}
...
%                     end
            ...
            switch obj.ConvFlag
                case {'OFF','DopplerEffect'}
                    obj.tmpline = (obj.KrLine(Phi0_temp,W_temp,E_temp,obj.Te));
                case 'Voigt'
        ...
        function ComputeKrDSallPixels(obj,varargin)
            ...
            switch obj.TD
                case 'KrK32'
                    obj.KrDSallPixels = arrayfun(@(x) obj.KrLine(x,obj.K32_W,obj.K32_E,obj.Te),obj.K32_Phi0allPixels,'UniformOutput',false);
                ...
                case {'KrL3_32','KrL3_32_HS','MoSFitterJuly2017','DummyKrdc1'}
                    ...
                    obj.KrDSallPixels = arrayfun(@(x) obj.KrLine(x,obj.L3_32_W,obj.L3_32_E,obj.Te),obj.L3_32_Phi0allPixels,'UniformOutput',false);
                    %                     for i=1:1:obj.nPixels
                    ...
                    switch IStype
                        ...
                        case 'TRAPEZ'  % Trapezoidal integral --> faster, less accurate
                            for qUi = 1:1:obj.nqU
                                ...
                                if qUieq < obj.nTe
                                    obj.KrIS(qUi) = ...
                                        (trapz(obj.Te(qUieq:end),obj.KrDS(qUieq:end).*obj.KTF(obj.Te(qUieq:end),obj.qU(qUi),obj.MACE_R_eV))+obj.BKG_RateSec).*...
                                        obj.TimeSec.*obj.qUfrac(qUi);
                                    obj.KrISE(qUi) = obj.KrIS(qUi).^.5;
                                else
