...
if ~exist('../KNM1_RingAnalysis/plots/','dir')
    system('mkdir ../KNM1_RingAnalysis/plots/');
end

savename = sprintf('../KNM1_RingAnalysis/plots/E0ringwise_%sRuns_%.0frange.png',RWlabel,range);
...
% xlim([0.5,12.5])
% 
% print(sprintf('../KNM1_RingAnalysis/plots/BackgroundRateRings_%sRuns_%.0feVrange.png',RWlabel,range),'-dpng','-r500');
%% plot spectrum
% Mode = 'Counts';
