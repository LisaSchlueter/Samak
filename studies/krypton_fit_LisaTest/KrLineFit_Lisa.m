...
p.addParameter('Mode','Data',@(x)ismember(x,{'Data','Sim','MoSFitterJuly2017','KrL3_32_Satellites'}));
...
switch TD
    case {'KrK32','KrL3_32','KrL3_32_HS'}
        A=InitKrKATRIN('TD',TD,'FPD_Pixel',Pixel,...
            'ConvFlag',ConvFlag,...
    ...
    case  'KrL3_32_Satellites'
        A=InitKrKATRIN_LisaFit('TD',TD,'FPD_Segmentation','OFF',...
            'HVRipples','OFF','ConvFlag',ConvFlag,'CPS','OFF', ...
