...
normcutoff = 1e7;
if nargin < 2,
    error('mystats:student_cdf:TooFewInputs','Requires two input arguments.');
end

[errorcode x v] = distribution_check(2,x,v);

if errorcode > 0
    error('mystats:student_cdf:InputSizeMismatch',...
