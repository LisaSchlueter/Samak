...
PrettyFigureFormat
saveas(42,'plots/CMdecompose_BM1S.png');
...
title('log(abs(normalization term))')
PrettyFigureFormat
saveas(422,'plots/CorMdecompose_BM1S.png');
