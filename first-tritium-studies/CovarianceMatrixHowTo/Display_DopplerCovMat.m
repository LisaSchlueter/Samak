...
myEffects = struct('DOPoff','ON'); % choose 1 Effect only!  
MRA.InitializeCM('SysEffect',myEffects,'nTrials',1000,...
                  'Recompute','ON','DataDriven','ON');
              
MRA.FitCM_Obj.ComputeCM_DOPoff;
MRA.FitCM_Obj.PlotCM('ConvergenceTest','OFF','saveplot','OFF');

saveas(110,'plots/CMplot_DOPoff.png');
...
PrettyFigureFormat
saveas(42,'plots/CMdecompose_DOPoff.png');
...
title('log(abs(normalization term))')
PrettyFigureFormat
saveas(422,'plots/CorMdecompose_DOPoff.png');
