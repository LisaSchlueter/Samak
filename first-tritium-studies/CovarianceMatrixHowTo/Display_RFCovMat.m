...
myEffects = struct('RF_EL','ON',...  % Response Function(RF) EnergyLoss
                   'RF_BF','ON',...  % RF B-Fields
                   'RF_RX','ON');    % Column Density, inel cross ection); % choose 1 Effect only!  
MRA.ComputeCM('SysEffect',myEffects,'nTrials',1000,...
                  'Recompute','OFF','DataDriven','ON');
              
MRA.FitCM_Obj.ComputeCM_RF;
MRA.FitCM_Obj.PlotCM('ConvergenceTest','ON','saveplot','OFF');

saveas(110,'plots/CMplot_RF.png');
...
PrettyFigureFormat
saveas(42,'plots/CMdecompose_RF.png');
...
PrettyFigureFormat
saveas(422,'plots/CorMdecompose_RF.png');