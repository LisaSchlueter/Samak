...
myEffects = struct('TCoff_OTHER','ON'); % choose 1 Effect only!  
...
saveas(110,'plots/CMplot_TCoffOther.png');
...
colorbar
title('TCoff-OTHER decomposition: normalization term')
PrettyFigureFormat
subplot(2,2,2)
...
PrettyFigureFormat
saveas(42,'plots/CMdecompose_TCoffOther.png');
...
title('log(abs(normalization term))')
PrettyFigureFormat
saveas(422,'plots/CorMdecompose_TCoffOther.png');
