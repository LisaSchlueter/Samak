...
MRA = MultiRunAnalysis('RunList',RunList,'exclDataStart',9);
...
MRA.FitCM_Obj.PlotCM('ConvergenceTest','ON','saveplot','ON');

%saveas(110,'plots/CMplot_FSD.png');
...
PrettyFigureFormat
saveas(42,'plots/CMdecompose_FSD.png');
...
title('log(abs(normalization term))')
PrettyFigureFormat
saveas(422,'plots/CorMdecompose_FSD.png');
