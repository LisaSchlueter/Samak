...
myEffects = struct('TCoff_RAD','ON'); % choose 1 Effect only!  
...
saveas(110,'plots/CMplot_TCoffRad.png');
...
colorbar
title('TCoff-RAD decomposition: normalization term')
PrettyFigureFormat
subplot(2,2,2)
...
PrettyFigureFormat
saveas(42,'plots/CMdecompose_TCoffRad.png');
...
title('log(abs(normalization term))')
PrettyFigureFormat
saveas(422,'plots/CorMdecompose_TCoffRad.png');
