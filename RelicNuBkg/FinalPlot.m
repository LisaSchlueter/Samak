...
hold on;
[q,t]=contour(mnuScanPoints,etaScanPoints,(Chi2-GlobalChi2Min).',[0 2.3]);
t.LineWidth = 2;
[r,u]=contour(mnuScanPoints,etaScanPoints,(Chi2-GlobalChi2Min).',[0 6.18]);
u.LineWidth = 2;
[s,v]=contour(mnuScanPoints,etaScanPoints,(Chi2-GlobalChi2Min).',[0 11.83]);
v.LineWidth = 2;
v.Color=[0 0.8 0.8];
[~,w]=contour(mnuScanPoints(10:end),etaScanPoints,(Chi2(10:end,:)-GlobalChi2Min).',[0 11.83]);
w.LineWidth=4;
w.Color=[0 0.5 0.5];
ylabel('\eta','FontSize',12);
xlabel('m_{\nu}^{2} (eV^{2})','FontSize',12);
zlabel('\Delta\chi^2','FontSize',12);
text(0.4,4.5e11,'1\sigma C.L.','FontSize',14);
text(0.4,5.9e11,'2\sigma C.L.','FontSize',14);
text(0.4,7e11,'3\sigma C.L.','FontSize',14);
xlim([-1,1]);
ylim([0,inf]);
...
b=annotation('line',[0.845 0.845],[0.13 0.87]);
b.LineWidth=2;
b.Color=[0 0 1];
...
d=annotation('textarrow',[0.78 0.82],[0.4 0.47],'String','Global best fit');
d.FontSize=16;
e=annotation('textarrow',[0.5 0.6],[0.85 0.8],'String','\eta limit (3\sigma C.L.)');
e.FontSize=16;
PrettyFigureFormat;
hold off;
