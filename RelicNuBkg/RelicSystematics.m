...
B.SystBias('TwinBias_mnuSq',0,'Recompute','ON','Plot','OFF','DeltaChi2',1);
B.SystBias('TwinBias_mnuSq',1,'Recompute','ON','Plot','OFF','DeltaChi2',1);
B.SystBias('TwinBias_mnuSq',5,'Recompute','ON','Plot','OFF','DeltaChi2',1);
