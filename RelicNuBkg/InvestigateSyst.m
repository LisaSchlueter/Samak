...
T = plot(M.RunData.qU,ErrTotal,'LineWidth',2);
hold on;
f = plot(M.RunData.qU,ErrFSD,'LineWidth',2);
r = plot(M.RunData.qU,ErrRF,'LineWidth',2);
t = plot(M.RunData.qU,ErrTASR,'LineWidth',2);
s = plot(M.RunData.qU,ErrStack,'LineWidth',2);
F = plot(M.RunData.qU,ErrFPD,'LineWidth',2);
c = plot(M.RunData.qU,ErrTC,'LineWidth',2);
b = plot(M.RunData.qU,ErrBkg,'LineWidth',2);
