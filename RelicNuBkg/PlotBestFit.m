function PlotBestFit(varargin)
    ...
    if exist(sprintf('./EtaFitResult_%s_AllParams_mnuSq%g_Nfit%g.mat',RunList,mnuSq,Nfit),'file') && Nfit>1
        ...
        if strcmp(Plot,'ON')
            errormat_M=[M.FitResult.errmat(1,1:4) M.FitResult.errmat(1,18);...
                        M.FitResult.errmat(2,1:4) M.FitResult.errmat(2,18);...
                        M.FitResult.errmat(3,1:4) M.FitResult.errmat(3,18);...
                        M.FitResult.errmat(4,1:4) M.FitResult.errmat(4,18);...
                        M.FitResult.errmat(18,1:4) M.FitResult.errmat(18,18)];
                    
            errormat_D=[D.FitResult.errmat(1,1:4) D.FitResult.errmat(1,18);...
                        D.FitResult.errmat(2,1:4) D.FitResult.errmat(2,18);...
                        D.FitResult.errmat(3,1:4) D.FitResult.errmat(3,18);...
                        D.FitResult.errmat(4,1:4) D.FitResult.errmat(4,18);...
                        D.FitResult.errmat(18,1:4) D.FitResult.errmat(18,18)];
