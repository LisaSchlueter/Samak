...
%% Settings
E0 = 18575;                                         % Endpoint in eV
range = 30;
initfile1=@ref_RelicNuBkg_DesignReport;
initfile2=@ref_RelicNuBkg_SensitivityLimit;

%% Data
D = RunAnalysis('RunNr',6,...
    'FakeInitFile',initfile2,...
...
R = RunAnalysis('RunNr',5,...
     'FakeInitFile',initfile1,...
    'chi2','chi2Stat',...                 % uncertainties: statistical or stat + systematic uncertainties
    'DataType','Fake',...                 % can be 'Real' or 'Twin' -> Monte Carlo
    'TwinBias_Q',18575,...
    'RingList',1:14,...
