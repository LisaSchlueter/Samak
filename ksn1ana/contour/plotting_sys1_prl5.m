...
file_A     = 'coord_syst-FPDeff.mat';
file_B     = 'coord_syst-FSD.mat';
file_C     = 'coord_syst-RF_BF.mat';
file_D     = 'coord_syst-RF_BX.mat';
file_E     = 'coord_syst-RF_EL.mat';
file_F     = 'coord_syst-Stack.mat';
file_G     = 'coord_syst-TASR.mat';
file_H     = 'coord_syst-TCoff_OTHER.mat';
file_I     = 'coord_syst-BKG.mat';
file_J     = 'coord_90eV_Real_syst.mat';
...
% Labels
katrinA  = 'Stat+Sys - FPD';
katrinB  = 'Stat+Sys - Final State Distribution';
katrinC  = 'Stat+Sys - Magnetic Fields';
katrinD  = 'Stat+Sys - Column Density';
katrinE  = 'Stat+Sys - Energy Loss function';
katrinF  = 'Stat+Sys - HV Fluctuations';
katrinG  = 'Stat+Sys - Tritium activity fluctuations';
katrinH  = 'Stat+Sys - Theoretical corrections';
katrinI  = 'Stat+Sys - Background Slope';
katrinJ  = 'KSN1 Stat+Sys - 90%CL';
...
axis square
export_fig(fig,'./plots/ksn1_contour_test4.pdf')
