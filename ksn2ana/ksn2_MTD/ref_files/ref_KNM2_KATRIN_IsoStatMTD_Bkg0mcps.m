function TritiumObject = ref_KNM2_KATRIN_IsoStatMTD_Bkg0mcps(varargin)
...
IsoStatMTD   = importdata([getenv('SamakPath'),'ksn2ana/ksn2_MTD/ref_files/KSN2IsoStatMTD.mat']);
qU = IsoStatMTD.qU;
