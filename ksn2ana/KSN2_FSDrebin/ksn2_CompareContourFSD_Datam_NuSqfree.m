...
pHandles{i} = S.ContourPlot('HoldOn',HoldOn,'Color',rgb(Colors{i}),'LineStyle',LineStyle{i},'BestFit','ON');
...
MakeDir(plotdir);
plotname = sprintf('%sksn2_CompareContourFSD_Data_mNuSqFree.png',plotdir);
