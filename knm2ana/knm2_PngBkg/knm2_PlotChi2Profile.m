...
% load CM
savenameCM = sprintf('%sChi2Profile_Real_UniformScan_mNu_Knm2_Ring_FullFPD_chi2CMShape_SysBudget41_NP1.112_FitParE0BkgNormqU_nFit20_min-2_max1.mat',savedir);
