...
savename = [savedir,sprintf('knm2_RunStacking_%s_%.0feV.mat',RunList,range)];
...
if exist(savename,'file')
    ...
    save(savename,'FitResult','CommonArg','A');
end

%% display neutrino mass shift
fprintf('Mean');
fprintf('------------------------------------------- \n')
fprintf('mNuSq bias =  %.3f eV^2 \n',FitResult.par(1));
fprintf('E0    bias =  %.3f eV \n',FitResult.par(2)+A.ModelObj.Q_i-TwinBias_Q);
fprintf('------------------------------------------- \n')
