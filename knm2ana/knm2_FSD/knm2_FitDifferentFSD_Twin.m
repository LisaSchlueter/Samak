...
savename = sprintf('%sknm2_DifferentFSD_%.0feV_%s_statNP_Uniform_MC.mat',...
...
if exist(savename,'file')
    ...
    A = MultiRunAnalysis(RunAnaArg{:},'FSDFlag','KNM2','DopplerEffectFlag','FSD');
    ...
    C = MultiRunAnalysis(RunAnaArg{:},'FSDFlag','SAENZ','DopplerEffectFlag','FSD');
...
% GetFigure;
% b1 = bar(SaenzTT(:,1),SaenzTT(:,2));
% hold on;
% b2 = bar(KNM2TT(:,1),KNM2TT(:,2));
