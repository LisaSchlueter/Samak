function [PixList,RingPixList] = AziHalfPatch2PixelCombi(myRingList,myPixList)
...
if any(ismember(myRingList,1))
    ...
    PixList_all = [PixList_all,NE,SE,PoleE];
    RingPixList{1} = [NE,SE,PoleE];

end

%west
if any(ismember(myRingList,2))
    PoleW = [1,2,8:13,19:24]+1;
    ...
    PixList_all = [PixList_all,NW,SW,PoleW];
    RingPixList{2} = [NW,SW,PoleW];
end
