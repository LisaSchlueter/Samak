function TritiumObject = ref_stackedruns(StackFileName,ex2,varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% CONFIGURATION FILE
% First Tritium Runs
%
...
%Load RunSummary
D = importdata([StackFileName,ex2,'.mat']); 
...
p.addParameter('TD',['Run',StackFileName,ex2]);
