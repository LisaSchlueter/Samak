function TritiumObject = ref_runsummariesmpix(RunNr,pixlist,varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% CONFIGURATION FILE
% First Tritium Runs
%
...
p.addParameter('FPD_Segmentation','SINGLEPIXEL',@(x) ismember(x,{'SINGLEPIXEL','MULTIPIXEL'}));
...
opt_doppler = {'DopplerEffectFlag','OFF'};
