function TritiumObject = ref_KNMX_Final_2h_1000runs_GasCombo(varargin)
...
p.addParameter('WGTS_MolFrac_HT',0.04,@(x)isfloat(x)&& x>0);
...
% General
p.addParameter('TimeSec',1000*2*60*60,@(x)isfloat(x));
