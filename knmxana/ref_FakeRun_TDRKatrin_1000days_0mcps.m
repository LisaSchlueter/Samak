function TritiumObject = ref_FakeRun_TDRKatrin_1000days_0mcps(varargin)
TDMode = 'DataTBD';

% use MTD from a KNM2 run
filename = [getenv('SamakPath'),'tritium-data/mat/Knm2/56196.mat']; %take MTD from 1 (randomly chosen) KNM2 run
...
p.addParameter('DopplerEffectFlag','OFF',@(x)ismember(x,{'OFF','FSD'}));
...
p.addParameter('BKG_RateAllFPDSec',0.0000001);
