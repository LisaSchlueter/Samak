...
% Plot m2
RC4.PlotFits('SavePlot','ON','PlotPar',1,'Blind','OFF','PlotMode','Rel');
...
% Plot N
RC4.PlotFits('SavePlot','ON','PlotPar',4,'Blind','OFF');
...
% Uniform
cov_m2e0 = MRL.FitResult.errmat(1:2,1:2);
fit_m2e0 = [MRL.FitResult.par(1) MRL.FitResult.par(2)];
hold on
CLsigma(2)='2';
r_ellipse = MRL.DrawEllipseError(fit_m2e0,cov_m2e0,'CL',CLsigma(2));
