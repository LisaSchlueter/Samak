...
myMainTitle = sprintf('KATRIN - KNM1 Subrun-wise Background - %d Runs - [%.0f - %0.f] eV',...
...
fig1      = figure('Name','KATRIN - KNM1 Subrun-wise Background','NumberTitle','off','rend','painters','pos',[10 10 1200 600]);
...
savefile    = sprintf('plots/BackgroundSubRunWise_%d_%s_%.0feVbelowE0_2.png',...
    numel(Real.RunList),Real.chi2,abs(range));
fig1      = figure('Name','KATRIN - KNM1 Subrun-wise Background','NumberTitle','off','rend','painters','pos',[10 10 1000 1000]);
a=annotation('textbox', [0 0.9 1 0.1], 'String', maintitle,'EdgeColor', 'none','HorizontalAlignment', 'center');
a.FontSize=18;a.FontWeight='bold';
...
myMainTitle = sprintf('KATRIN - KNM1 Subrun-wise Background - %d subruns - [%.0f - %0.f] eV',...
