...
% ax1.Position = [mypos1(1) mypos1(2)-0.08 mypos1(3) mypos1(4)+0.14];
% ax2.Position = [mypos2(1) mypos2(2)-0.055 mypos2(3) mypos2(4)+0.05];
% ax3.Position = [mypos3(1) mypos3(2)-0.03 mypos3(3) mypos3(4)+0.05];
ax1.Position = [mypos1(1)+0.04 mypos1(2)-0.15 mypos1(3) mypos1(4)+0.2];
ax2.Position = [mypos2(1)+0.04 mypos2(2)-0.095 mypos2(3) mypos2(4)+0.023];
ax3.Position = [mypos3(1)+0.04 mypos3(2)-0.04 mypos3(3) mypos3(4)+0.023];
%zoomBox.Position = [0.43 0.58 .46 .16];
zoomBox.Position = [0.531 0.58 .393 .16];
...
zoomBox.FontSize = 22;
leg1.FontSize = 16;
leg1.Position = [0.11   0.895    0.88    0.0916];
ax1.YLabel.FontSize = 23;
ax2.YLabel.FontSize = 23;
ax3.YLabel.FontSize = 23;
ax3.XLabel.FontSize = 23;
ax1.YLabel.Position(1) =1.9867e+03;
...
MakeDir(savedir);
savename = sprintf('%sknm1_propagandaCombi',savedir);
